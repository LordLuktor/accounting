...
import { Save, User, Mail, Lock, ArrowLeft } from 'lucide-react';
  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-slate-600">Manage your personal account information</p>
      </div>
      ...
      <div className="bg-white rounded-xl p-6 border border-slate-200">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="text-center p-4 bg-slate-50 rounded-lg">
            ...
            <p className="font-semibold text-slate-800 capitalize">{user?.subscription_status}</p>
          </div>
          <div className="text-center p-4 bg-slate-50 rounded-lg">
